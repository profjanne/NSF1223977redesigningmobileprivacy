...
public class UnInstallDao implements DaoTemplate<UnInstallRecord> {
	private static final String INSERT = "insert into "
			+ DataConstants.UN_INSTALL_TABLE_NAME + "("+BaseColumns._ID+", " + UnInstallColumns.PKGNAME+ ", " 
			+ UnInstallColumns.APPNAME + ", "
			+ UnInstallColumns.DATE + ", "
			+ UnInstallColumns.MILISECONDS+ ", "
			+ UnInstallColumns.LOGITUDE + ", "
			+ UnInstallColumns.LATITUDE+ ", " 
			+ UnInstallColumns.OPERATION
			+ ") values (null,?, ?, ?,?, ?, ?,?)";
...
//		insertStatement.bindDouble(6, entity.getLatitude());
	...
	public UnInstallRecord get(long id) {
	      ...
	      Cursor c =
	               db.query(DataConstants.UN_INSTALL_TABLE_NAME, new String[] { BaseColumns._ID,
	            		   UnInstallColumns.PKGNAME,
	            		   UnInstallColumns.APPNAME, UnInstallColumns.DATE, UnInstallColumns.MILISECONDS,
	            		   UnInstallColumns.LOGITUDE, UnInstallColumns.LATITUDE, UnInstallColumns.OPERATION},
...
//	    	  unInstallRecord.setLatitude(c.getDouble(6));
	...
	public List<UnInstallRecord> getAll()
	{
		List<UnInstallRecord> list = new ArrayList<UnInstallRecord>();
	      Cursor c =
	               db.query(DataConstants.UN_INSTALL_TABLE_NAME, new String[] { BaseColumns._ID,
	            		   UnInstallColumns.PKGNAME, UnInstallColumns.APPNAME, UnInstallColumns.DATE,
	            		   UnInstallColumns.MILISECONDS, UnInstallColumns.LOGITUDE, UnInstallColumns.LATITUDE,
	            		   UnInstallColumns.OPERATION},
	                        null,
	                        null, null, null, BaseColumns._ID, null);
	      if (c.moveToFirst()) {
	         do {
	        	 UnInstallRecord unInstallRecord = this.buildUnInstallRecordFromCursor(c);
	...
	public void deleteAll(SQLiteDatabase db) {
		db.delete(DataConstants.UN_INSTALL_TABLE_NAME, null,
				null);
	}
