...
public final class FileUtil {
   ...
   public static final String EXT_STORAGE_PATH_ANDROID_APPFORE = "/Android/appfore";
   ...
   public static File getExternalDirAn() {
	      File dir =
	               new File(Environment.getExternalStorageDirectory() + EXT_STORAGE_PATH_ANDROID_APPFORE);
	      synchronized (FileUtil.DATA_LOCK) {
	         try {
	            dir.mkdirs();
	            dir.createNewFile();
