...
public final class Constants {
	public final static String LOG_TAG="TAG";
	   ...
	   public static final boolean DBREADFILE=false;
	   ...
	   public static final int MAXMISTOAST=5; 
	   public static final int MAXINTERVALMISMINUTE=3; 
	   ...
	   public static final String AppName="AllTrackSurface";
